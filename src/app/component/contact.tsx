...
export default function Contact() {
  return (
    <div id='contact' className="bg-black h-[90vh]">
      ...
      <form action="#" method="POST" className="flex flex-col items-center space-y-4">
        <div className="flex flex-col w-[90%] md:flex-row space-y-4 md:space-x-4 md:space-y-0 md:w-[80%]">
          <input
            ...
            required
            className="w-[100%] p-2 rounded-md bg-[#323946]"
          />
          <input
            type="email"
        ...
        <input
          type="submit"
          value="Send Message"
          className="w-[90%] p-2 rounded-md bg-color text-white cursor-pointer hover:bg-[#41d4a3] md:w-[80%] md:py-3 md:text-[25px]"
        />
      </form>
    </div>
  );
