...
//       <h2 className="text-white text-[70px] font-extrabold text-center mb-10">
//         Skills
//       </h2>
...
//             style={{
//               background: `conic-gradient( #41EEB5  ${skill.proficiency}%, #333333 ${skill.proficiency}%)`,
//             }}
//           >
